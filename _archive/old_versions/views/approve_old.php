...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Final approval or decline decision</p>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="?route=requests/approve&id=<?= $request['id'] ?>" id="approvalForm">
                        ...
                        <div class="mb-3">
                            <label for="approval_decision" class="form-label">Approval Decision <span class="text-danger">*</span></label>
                            <select name="approval_decision" id="approval_decision" class="form-select" required onchange="toggleDecisionFields()">
                        ...
                        <div class="mb-3">
                            <label for="approval_comments" class="form-label">Comments <span class="text-danger">*</span></label>
                            <textarea name="approval_comments" id="approval_comments" class="form-control" rows="4" required 
...
function toggleDecisionFields() {
    ...
    const infoRequired = document.getElementById('info_required');
...
document.getElementById('approvalForm').addEventListener('submit', function(e) {
    ...
    const infoRequired = document.getElementById('info_required').value.trim();
    ...
    if (decision === 'request_more_info' && !infoRequired) {
        e.preventDefault();
    ...
    // Confirmation
    const actionText = decision === 'approve' ? 'approve' : (decision === 'decline' ? 'decline' : 'request more information for');
...
document.getElementById('approval_decision').addEventListener('change', function() {
