...
<div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <dl class="row">
                            ...
                            <dd class="col-sm-7">
                                <strong><?= htmlspecialchars($withdrawal['item_name']) ?></strong><br>
                ...
                <form method="POST" action="?route=withdrawals/approve&id=<?= $withdrawal['id'] ?>">
                    ...
                    <div class="alert alert-info">
                        ...
                        <ul class="mb-0">
                            ...
                            <li>Consumable is required for legitimate project activities</li>
                            <li>Receiver is authorized and accountable for the consumable</li>
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="card-title mb-0">
                    <i class="bi bi-box me-2"></i>Consumable Details
                </h6>
            </div>
            <div class="card-body">
                <dl class="row">
                    <dt class="col-sm-5">Reference:</dt>
                    <dd class="col-sm-7"><?= htmlspecialchars($withdrawal['item_ref']) ?></dd>
                ...
                <a href="?route=assets/view&id=<?= $withdrawal['asset_id'] ?>" class="btn btn-outline-primary w-100">
                    <i class="bi bi-eye me-1"></i>View Consumable Details
                </a>
            </div>
        </div>
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            ...
                            <p class="timeline-text">Consumable release</p>
