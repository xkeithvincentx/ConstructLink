        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="bi bi-form-check me-2"></i>Edit Project Information
                </h5>
            </div>
            <div class="card-body">
                <form method="POST" action="?route=projects/edit&id=<?= htmlspecialchars($formData['id'] ?? $_GET['id'] ?? '') ?>" class="needs-validation" novalidate id="projectForm">
