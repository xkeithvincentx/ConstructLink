        ...
        <div class="d-flex flex-wrap gap-2 align-items-center">
            ...
            <div class="d-none d-md-flex align-items-center gap-2">
                ...
                <select id="recordsPerPage"
                    ...
                    <option value="5" <?= (isset($_GET['per_page']) && $_GET['per_page'] == 5) || (!isset($_GET['per_page']) && PAGINATION_PER_PAGE_BORROWED_TOOLS == 5) ? 'selected' : '' ?>>5</option>
            ...
            <?php if (isset($pagination)): ?>
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mt-4 gap-3">
                    ...
                    <?php if ($pagination['total_pages'] > 1): ?>
                        <nav aria-label="Borrowed tools pagination">
                            <ul class="pagination pagination-sm mb-0 justify-content-center justify-content-md-end">
                                ...
                                <?php if ($pagination['current_page'] > 1): ?>
                                    <li class="page-item">
                                        ...
                                        ?>
                                        <a class="page-link"
                                           href="?route=borrowed-tools&<?= http_build_query($prevParams) ?>"
                                ...
                                ?>
                                    <li class="page-item">
                                        <a class="page-link"
                                           href="?route=borrowed-tools&<?= http_build_query($firstParams) ?>"
                                ...
                                <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                                    ...
                                    <?php else: ?>
                                        <li class="page-item">
                                            ...
                                            ?>
                                            <a class="page-link"
                                               href="?route=borrowed-tools&<?= http_build_query($pageParams) ?>"
                                ...
                                <?php if ($endPage < $pagination['total_pages']): ?>
                                    ...
                                    <li class="page-item">
                                        ...
                                        ?>
                                        <a class="page-link"
                                           href="?route=borrowed-tools&<?= http_build_query($lastParams) ?>"
                                ...
                                <?php if ($pagination['current_page'] < $pagination['total_pages']): ?>
                                    <li class="page-item">
                                        ...
                                        ?>
                                        <a class="page-link"
                                           href="?route=borrowed-tools&<?= http_build_query($nextParams) ?>"
