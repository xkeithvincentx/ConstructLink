<?php
/**
 * ConstructLink™ Transfer Approve View
 * Form to approve a transfer request
 */
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">
        <i class="bi bi-check-circle me-2"></i>Approve Transfer Request
    </h1>
...
<div class="row">
    <div class="col-lg-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="?route=transfers/approve&id=<?= $transfer['id'] ?>" class="needs-validation" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="approval_notes" name="approval_notes" rows="4" 
                                  placeholder="Add any notes or conditions for this approval..."><?= htmlspecialchars($formData['approval_notes'] ?? '') ?></textarea>
                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="confirm_approval" name="confirm_approval" value="1" required>
                ...
                <div class="alert alert-danger mt-4">
                    <i class="bi bi-exclamation-triangle me-2"></i>You do not have permission to approve this transfer or it is not in an approvable status.
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header">
                <h6 class="card-title mb-0">
                    <i class="bi bi-info-circle me-2"></i>Approval Guidelines
                </h6>
            </div>
            <div class="card-body">
                <div class="mb-3">
