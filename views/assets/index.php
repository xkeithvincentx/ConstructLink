...
<!-- Page Header -->
<div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center pt-3 pb-2 mb-3 border-bottom gap-2">
    <h1 class="h2 mb-2 mb-lg-0">
        <i class="bi bi-box-seam me-2"></i>
        Asset Management
    </h1>
    <div class="btn-toolbar flex-wrap gap-2">
        <div class="btn-group flex-wrap" role="group" aria-label="Primary Actions">
            ...
            <?php if (in_array($userRole, $roleConfig['assets/legacy-create'] ?? [])): ?>
                <a href="?route=assets/legacy-create" class="btn btn-success btn-sm">
                    <i class="bi bi-plus-circle me-1"></i>
                    <span class="d-none d-md-inline">Add Legacy</span>
                    <span class="d-md-none">Legacy</span>
                </a>
            <?php endif; ?>
        </div>
        
        <div class="btn-group flex-wrap" role="group" aria-label="Dashboard Actions">
            <?php if (in_array($userRole, $roleConfig['assets/legacy-verify'] ?? [])): ?>
                <a href="?route=assets/verification-dashboard" class="btn btn-warning btn-sm">
            ...
            <?php if (in_array($userRole, $roleConfig['assets/legacy-authorize'] ?? [])): ?>
                <a href="?route=assets/authorization-dashboard" class="btn btn-info btn-sm">
        ...
        <div class="btn-group flex-wrap" role="group" aria-label="Tools">
            ...
            <?php if (in_array($userRole, ['System Admin', 'Warehouseman', 'Site Inventory Clerk', 'Asset Director'])): ?>
                <a href="?route=assets/tag-management" class="btn btn-outline-primary btn-sm">
                    <i class="bi bi-qr-code me-1"></i>
                    <span class="d-none d-lg-inline">Tags</span>
                    <span class="d-lg-none">Tag</span>
                </a>
            <?php endif; ?>
            <button type="button" class="btn btn-outline-secondary btn-sm" onclick="refreshAssets()" title="Refresh">
