    ...
    public function view() {
        ...
        try {
            ...
            try {
                ...
                error_log("Could not load project assets: " . $e->getMessage());
                $projectAssets = [];
            }
            ...
            try {
                ...
                error_log("Could not load project users: " . $e->getMessage());
                $projectUsers = [];
            }
            ...
            try {
                ...
                error_log("Could not load project activity: " . $e->getMessage());
                $projectActivity = [
                    'total_withdrawals' => 0,
            ...
            try {
                ...
                error_log("Could not load recent procurements: " . $e->getMessage());
                $recentProcurements = ['data' => []];
            }
