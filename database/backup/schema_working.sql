...
-- Table structure for table `procurement` (Enhanced)
CREATE TABLE `procurement` (
  ...
  `vat_amount` decimal(15,2) GENERATED ALWAYS AS (`subtotal` * `vat_rate` / 100) STORED,
  `ewt_rate` decimal(5,2) DEFAULT 2.00,
  `ewt_amount` decimal(15,2) GENERATED ALWAYS AS (`subtotal` * `ewt_rate` / 100) STORED,
  `handling_fee` decimal(15,2) DEFAULT 0.00,
  `net_total` decimal(15,2) GENERATED ALWAYS AS (`subtotal` + `vat_amount` + `handling_fee` - `ewt_amount`) STORED,
  `total_cost` decimal(15,2) GENERATED ALWAYS AS (`subtotal` + `vat_amount` + `handling_fee` - `ewt_amount`) STORED,
  ...
  `justification` text,
  `status` enum('Pending','Reviewed','For Revision','Approved','Rejected','Delivered','Received') NOT NULL DEFAULT 'Pending',
  ...
  CONSTRAINT `procurement_ibfk_1` FOREIGN KEY (`vendor_id`) REFERENCES `vendors` (`id`),
  CONSTRAINT `procurement_ibfk_2` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`),
  CONSTRAINT `procurement_ibfk_3` FOREIGN KEY (`requested_by`) REFERENCES `users` (`id`),
  CONSTRAINT `procurement_ibfk_4` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `procurement_ibfk_5` FOREIGN KEY (`request_id`) REFERENCES `requests` (`id`) ON DELETE SET NULL,
  CONSTRAINT `procurement_ibfk_6` FOREIGN KEY (`received_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `procurement_logs` (
  ...
  KEY `user_id` (`user_id`),
  KEY `created_at` (`created_at`),
  CONSTRAINT `procurement_logs_ibfk_1` FOREIGN KEY (`procurement_id`) REFERENCES `procurement` (`id`) ON DELETE CASCADE,
  CONSTRAINT `procurement_logs_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

-- Table structure for table `assets` (Enhanced with procurement linkage)
CREATE TABLE `assets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `procurement_id` int(11) DEFAULT NULL COMMENT 'Link to procurement order',
  ...
  CONSTRAINT `assets_ibfk_6` FOREIGN KEY (`procurement_id`) REFERENCES `procurement` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `procurement_assets` (
  ...
  CONSTRAINT `procurement_assets_ibfk_1` FOREIGN KEY (`procurement_id`) REFERENCES `procurement` (`id`) ON DELETE CASCADE,
  CONSTRAINT `procurement_assets_ibfk_2` FOREIGN KEY (`asset_id`) REFERENCES `assets` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE INDEX `idx_procurement_status_project` ON `procurement` (`status`, `project_id`);
...
CREATE INDEX `idx_procurement_logs_date` ON `procurement_logs` (`procurement_id`, `created_at`);
